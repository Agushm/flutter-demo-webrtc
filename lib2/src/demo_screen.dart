...
class _MyAppState extends State<DemoScreen> {
  ...
  void _makeCall() async {
    ...
    try {
      ...
      */
      ...
      _offerController.text = description.sdp ?? '';
      ...
      _answerController.text = json.encode(description.sdp);
  ...
  void _createAnswer() async {
    try {
      RTCSessionDescription description =
          RTCSessionDescription(json.decode(_answerController.text), 'answer');
        ...
        children: [
          ...
          _inCalling
              ? FloatingActionButton(
                  ...
                  onPressed: _inCalling
                      ? () {
                          _createAnswer();
                        }
                      : null,
                  tooltip: _inCalling ? 'Answer' : 'Call',
                  child: Icon(
